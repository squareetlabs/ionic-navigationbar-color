...
module.exports = currentVersion => {
  return (
    new Package('ionic-readmes', [jsdocPackage, nunjucksPackage, typescriptPackage, linksPackage])
      ...
      .config(function (readFilesProcessor, readTypeScriptModules) {
        ...
        readTypeScriptModules.sourceFiles = ['./src/ionic/plugins/**/*.ts'];
      })

      // Configure file writing
      .config(function (writeFilesProcessor) {
        writeFilesProcessor.outputFolder = './dist/ionic/';
      })
